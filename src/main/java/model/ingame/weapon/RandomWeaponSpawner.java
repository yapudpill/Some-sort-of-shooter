...
public class RandomWeaponSpawner extends EntitySpawner implements IUpdateable {
    ...
    final static public List<WeaponFactory> availableWeaponsFactories = List.of(PistolModel::new, KnifeWeapon::new, RocketLauncher::new, ShotGun::new, RubberWeapon::new);
