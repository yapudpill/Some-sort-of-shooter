...
public class RubberProjectile extends Projectile {
    private static final double RUBBER_WIDTH = 0.3;
    private static final double RUBBER_HEIGHT = 0.3;
    private static final int RUBBER_DAMAGE = 20;
    private static final double RUBBER_SPEED = 0.1;
    private static final int MAX_BOUNCE_COUNT = 4;

    private int bounceCount = 0;

    RubberProjectile(Coordinates pos, ProjectileWeaponModel source, GameModel gameModel) {
