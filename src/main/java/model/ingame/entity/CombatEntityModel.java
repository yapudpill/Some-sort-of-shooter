...
public abstract class CombatEntityModel extends CreatureModel implements ICombatEntity {
    ...
    public CombatEntityModel(Coordinates pos, double speed, int maxHealth, double width, double height, GameModel gameModel) {
        super(pos, speed, maxHealth, width, height, gameModel);
