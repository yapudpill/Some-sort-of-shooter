...
public class Scenario extends IntervalMap<Double, IGameContext> {
    ...
    public static Scenario loadScenario(Resource scenarioResource) {
        ...
        scenario.put(1., new IGameContext.OneShotSpawnContext(Set.of(), Set.of(), Set.of(FirstAidKit::new)));
        scenario.put(2., new IGameContext.OneShotSpawnContext(Set.of(PistolModel::new), Set.of(), Set.of()));
        scenario.put(3., new IGameContext.OneShotSpawnContext(Set.of(), Set.of(ExplodingEnemy::new), Set.of()));
        scenario.put(6., new IGameContext.OneShotSpawnContext(Set.of(), Set.of(ExplodingEnemy::new), Set.of()));
        scenario.put(7., new IGameContext.OneShotSpawnContext(Set.of(RocketLauncher::new, RubberWeapon::new), Set.of(SmartEnemyModel::new, ExplodingEnemy::new), Set.of(FirstAidKit::new)));
        return scenario;
    }
}
